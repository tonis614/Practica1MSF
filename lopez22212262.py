...
plt.plot(t,PAu1,'--',color= clr2,label = 'Vs1(t)')
...
plt.plot(t,PAu2,'--',color= clr2,label = 'Vs1(t)')
...
plt.plot(t,PAu3,'--',color= clr2,label = 'Vs1(t)')
...
plt.plot(t,PAu4,'--',color= clr2,label = 'Vs1(t)')
